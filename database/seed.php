 ...
 *   - Web: http://localhost/bpo-systemUp/run-seed.php
 */
...
function seed_products(PDO $pdo): array
{
    $rows = [
        ...
        ['SEED-PRINT-BW', 'Black and White Printing', 'printing', 'service', 'service', 1.00, 3.00, 0, 0],
        ['SEED-PRINT-COLOR', 'Color Printing', 'printing', 'service', 'service', 5.00, 12.00, 0, 0],
        ...
        ['SEED-PHOTO-COLOR', 'Photocopy - Color', 'photocopy', 'service', 'service', 3.00, 8.00, 0, 0],
...
function seed_proposals(PDO $pdo, array $people, int $adminId, int $staffId): int
{
    $rows = [
        ...
        ['SEED-EMP-004', 'Inventory barcode labeling rollout', 'Inventory Management', 38000, '+35 days', 'approved', 'Barcode labels and scanner setup for faster stock counts.'],
