...
<div class="mb-5 flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
    <p class="page-intro mb-0">Create and download SQL backups. Store downloaded backups outside the local server.</p>
...
<section class="table-card data-panel">
    <div class="section-heading">
        ...
        <span class="badge"><?= h((string) count($backupFiles)) ?> file<?= count($backupFiles) === 1 ? '' : 's' ?></span>
    </div>
    ...
    <div class="data-panel-footer">
        Store downloaded backups outside the local server.
    </div>
</section>
