...
$hero = landing_section(
    ...
    'Sales, inventory, cash flow, rentals, fishpond operations, proposal requests, logbook entries, and official reports in one record management system.'
);
...
$services = [
    ...
    ['label' => 'IGP', 'title' => 'Income Projects', 'description' => 'Manage fishpond, rental, toga, printing, photocopy, and other project records.'],
            ...
            <div class="hero-inner">
                <div class="hero-copy">
                    ...
                    <div class="hero-actions">
                        <a href="login.php" class="btn btn-primary">Open System</a>
                        <a href="register.php" class="btn btn-secondary">Request Account</a>
                    </div>
